...
class user_post(models.Model):
    ...
    sender_type=models.BooleanField(default=False)#0 for user 1 for club
    post_type=models.BooleanField(default=False)#0 for event 1 for post
    title=models.CharField(max_length=264)
    image=models.ImageField(upload_to='postmain',blank=True,null=True)
    description=models.TextField()
    location=models.CharField(max_length=264,blank=True,null=True)
    attachment=models.FileField(upload_to='postextra',blank=True,null=True)
